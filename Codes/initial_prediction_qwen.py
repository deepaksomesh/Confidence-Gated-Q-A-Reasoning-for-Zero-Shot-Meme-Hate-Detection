...
LOG_FILE = os.path.join(OUTPUT_DIR, "Step1_qwen3_initial_predictions.jsonl")
METRICS_FILE = os.path.join(OUTPUT_DIR, "Step1_qwen3_initial_metrics.json")
...
def build_prompt(meme_text: str) -> str:
    """
    Creates the direct baseline prompt used for every meme.
    The model must answer Yes/No first, followed by a short reason.
    """
    return (
...
def main():
    ...
    """
    print("\nStarting Qwen3-VL initial prediction")
