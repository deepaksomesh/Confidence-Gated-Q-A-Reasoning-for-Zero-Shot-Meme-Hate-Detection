...
LOG_FILE = os.path.join(OUTPUT_DIR, "Step1_internvl_initial_predictions.jsonl")
METRICS_FILE = os.path.join(OUTPUT_DIR, "Step1_internvl_initial_metrics.json")
...
def build_messages(meme_text: str):
    """
    Builds the chat-style input expected by InternVL.
...
def main():
    ...
    """
    print("\nStarting InternVL3 initial prediction")
