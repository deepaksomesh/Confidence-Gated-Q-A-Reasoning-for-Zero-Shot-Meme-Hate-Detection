#!/bin/bash
#SBATCH --job-name=vlm_comparison
#SBATCH --output=/home/s4374827/NLP/Logs/vlm_comparison_%j.out
#SBATCH --error=/home/s4374827/NLP/Logs/vlm_comparison_%j.err
#SBATCH --nodes=1
#SBATCH --ntasks=1
